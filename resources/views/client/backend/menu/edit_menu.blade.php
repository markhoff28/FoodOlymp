        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
          ...
          <div class="page-title-right">
            <ol class="breadcrumb m-0">
              ...
              <li class="breadcrumb-item"><a href="{{ route('all.menu') }}">All Menu</a></li>
        ...
        <div class="card">
          <div class="card-body p-4">
            ...
            <form id="myForm" action="{{ route('menu.update') }}" method="post" enctype="multipart/form-data">
              ...
              <input type="hidden" name="old_image" value="{{ $menu->menu_image }}">
                ...
                <div class="col-lg-6">
                  <div class="mt-3 mt-lg-0">
                    ...
                    <div class="mb-3">
                      ...
                      <img id="showImage" src="{{ asset($menu->menu_image) }}" alt="" class="rounded-circle p-1 bg-primary" width="110">
                    </div>
                    <div class="mt-4">
